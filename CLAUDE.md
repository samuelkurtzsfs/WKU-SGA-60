...
- **Carlene Lodmell and Darlene Lodmell are two different people.** Their names differ by one
  ...
  against the university's own records, 1 September 2026, and a fourth time by SGA's own full
  1994-95 Congress roster, found pasted into a Spirit Masters scrapbook, which prints the two
